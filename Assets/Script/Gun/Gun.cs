...
public class Gun : MonoBehaviour
{
    ...
    public int CurrentMagazineCount => currentMagazineCount;
   ...
   public void ShowUi()
    ...
    {
        Bullet bullet = Instantiate<Bullet>(data.bulletPrefab,firePoint.position,Quaternion.identity); // Bullet 프리팹 생성
